...
from src.loss_computation.loss_helper_fcns import (
	batched_joint_logpdf,
	batch_sample_posterior,
)
...
def vanilla_loss(key, x, EBM_params, GEN_params, EBM_fwd, GEN_fwd):
	...
	llhood = batched_joint_logpdf(
		subkey, x, z_posterior, 1, EBM_params, GEN_params, EBM_fwd, GEN_fwd
	).mean()
	return -llhood, key
